...
# Import LightningChart and necessary libraries
import lightningchart as lc
import pandas as pd
...
# Filter data for the last 5 years (2018 to 2023)
...
for year in range(2018, 2024):
    ...
    # Add line series and set the name in the legend
